    ...
    <div class="wiki-page">
      ...
      <section class="hud-telemetry">
        ...
        <ul>
          ...
          <li><strong>Clima vivo:</strong> El lado derecho escucha al <code>AtmosphereWeatherService</code>: evento en curso, intensidad, precipitación, probabilidad de rayos y ETA con contador en segundos. Cada meteorología añade su propio tinte al panel para que identifiques el estado sin leer.</li>
      ...
      <section class="atmo-weather">
        ...
        <ul>
          ...
          <li><strong>Filtros y descargas sincronizadas:</strong> Cada evento meteorológico aplica su propio tinte sobre la cúpula (polvo ámbar, lluvia azulada, niebla gris, meteoros violáceos) y, cuando cae un rayo, la cámara recibe un flash blanco y un impulso extra de jitter. Los rayos nacen siguiendo la línea de visión real de la cámara y se trenzan entre cielo y suelo con geometría dedicada.</li>
          <li><strong>Precipitación dirigida:</strong> El snapshot atmosférico alimenta <code>ParticleEffectsService.updateWeatherPrecipitation()</code>, que ahora aumenta el <em>spawn rate</em>, el tamaño y la dispersión para que las gotas crucen el canopy, con ráfagas de polvo más anchas cerca de la cámara. La deriva y la gravedad siguen el evento activo y, al salir de la atmósfera, el servicio se limpia solo.</li>
        </ul>
