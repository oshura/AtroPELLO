  ...
  template: `
    ...
    <div class="wiki-page">
      ...
      <section class="atmo-weather">
        ...
        <ul>
          <li><strong>Capas temporales:</strong> <code>AtmosphereWeatherService</code> ahora genera eventos por estratos (superficie, baja, media y exósfera) con ventanas de ~2&nbsp;min, estados de calma reales y pesos distintos: tormentas cerca del suelo, polvo en enanas, meteoros casi exclusivos de la capa alta. El snapshot expone <em>layerId</em>, etiqueta y el rango de altitud activo, así HUD y sistemas de juego saben qué tramo estás atravesando.</li>
