  ...
  template: `
    ...
    <div class="wiki-page">
      ...
      <section class="atmo-flow">
        ...
        <ol>
          <li><strong>Entrada doble:</strong> Pulsa <kbd>Enter</kbd> con el piloto verde encendido para iniciar la secuencia cinematográfica desde la órbita, o vuelve a pulsarlo cuando ya vuelas dentro de la atmósfera para que el juego arme un descenso asistido. Ambos flujos apagan la música, muestran un breve fundido en negro y colocan la nave a ras del planeta.</li>
          <li><strong>Recupera el mando:</strong> Al volver la imagen estás a unos 40&nbsp;u del punto de contacto con una cámara rasante, impulso inicial y viento envolvente. No aparece la alarma de pérdida de sustentación y puedes corregir rumbo al instante.</li>
          <li><strong>Vigila el piloto verde:</strong> Mantente por debajo de 50&nbsp;u, a menos de 5&nbsp;u/s y con el morro alineado ±60° durante 3&nbsp;s para que la luz vuelva a activarse. Con esa luz encendida, otro toque a <kbd>Enter</kbd> dentro de la atmósfera provoca la misma toma asistida que viste en la cinemática, con polvo, cámara fija al suelo y apertura del panel unos segundos después.</li>
          <li><strong>Touchdown suave automático:</strong> Si rozas el suelo con menos de 1&nbsp;u/s en el eje vertical, el juego detecta el aterrizaje perfecto y lanza automáticamente la cámara bloqueada, el estallido de polvo y el swell de aterrizaje antes de mostrar el panel. Durante esos dos segundos sólo oyes el viento para que disfrutes la toma.</li>
          <li><strong>Golpes bruscos:</strong> Llegar demasiado rápido provoca un rebote físico, una advertencia «Impacto atmosférico» y daño proporcional. La nave vuelve a colocarse apenas por encima del suelo, así que puedes estabilizarte y volver a intentarlo en cuanto recuperes el control.</li>
          <li><strong>Panel y audio enfocados:</strong> El panel real aparece justo después del touchdown físico (o tras la animación asistida) y durante su apertura el juego corta tormentas y música para dejar solo el siseo del viento. Al cerrarlo recuperas todos los sonidos de clima.</li>
          <li><strong>Salida automática:</strong> Cuando te aburras del bioma basta con ascender; al pasar los 1000&nbsp;u la nave inicia sola la secuencia de despegue y te devuelve al sistema solar. Si prefieres hacerlo desde la UI, pulsa el botón Despegar en el panel y obtendrás exactamente la misma animación.</li>
        </ol>
