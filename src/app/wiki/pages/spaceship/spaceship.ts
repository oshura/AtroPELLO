    ...
    <div class="wiki-page">
      ...
      <section class="atmo-weather">
        ...
        <ul>
          ...
          <li><strong>Precipitación dirigida:</strong> El snapshot atmosférico alimenta <code>ParticleEffectsService.updateWeatherPrecipitation()</code>, que spawnea gotas o ráfagas de polvo frente a la cabina respetando deriva y gravedad; al salir de la atmósfera el servicio se limpia solo.</li>
        </ul>
