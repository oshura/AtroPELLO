...
- **Detección de colisión "de otra forma"**: PENDIENTE de diseñar más adelante (p. ej. volúmenes
  compuestos anillo-de-esferas + radios + núcleo, o colisión por secciones). No se implementa en Slice 1.
