...
### 8.3 Ajustes de la SEPARACION + panel (builds 72-73, 2026-08-18)
- Camara de la separacion FIJA (build 73): se planta UNA vez en el punto inicial de la antigua
  orbita (dist 150, camY 45 desde el ancla nave/puerto) y NO se mueve — solo sigue a la nave con
  la mirada mientras esta se aleja (antes: orbita que viajaba de 150 a 310u, quedaba demasiado
  cerca y en movimiento).
